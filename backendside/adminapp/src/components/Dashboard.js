      ...
      return (
        <div style={{ height: '100%', width: '100%' }}>
            ...
            <FormControl component="fieldset">
                ...
                <RadioGroup row aria-label="status" name="status" value={this.state.registerStatus} onChange={this.onSelectStatusChange}>
                    <FormControlLabel value="A" control={<Radio />} label="Đăng ký" />
                    <FormControlLabel value="W" control={<Radio />} label="Đang chờ" />
                    ...
                    <FormControlLabel value="AB" control={<Radio />} label="Vắng mặt" />
                </RadioGroup>
            </FormControl>
            </div>
          <br/>
          <MaterialTable 
            ...
            <Dialog open={openDialog} onClose={this.handleCloseDialog} aria-labelledby="form-dialog-title">
                <DialogTitle style={{backgroundColor: 'primary'}} id="form-dialog-title">Cập nhập đăng ký</DialogTitle>
                <DialogContent>
                    <DialogContentText>
                ...
                <DialogActions>
                <Button onClick={()=>this.handleSendDialogClick("email",dialogData["bid"],dialogData["code"])} color="primary">
                    Email xác nhận
                </Button>
                <Button onClick={()=>this.handleSendDialogClick("approve",dialogData["bid"],dialogData["code"])} color="primary">
                    Đã có mặt
                </Button>
                <Button onClick={()=>this.handleSendDialogClick("deny",dialogData["bid"],dialogData["code"])} color="primary">
                    Từ chối
                </Button>
                </DialogActions>
            </Dialog> 
