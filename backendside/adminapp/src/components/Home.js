...
export default class HomePage extends Component {
  ...
  openInformDialog() {
    ...
    setTimeout(() => this.setState({ openDialog: false }), 3000);
  }
  ...
  render() {
    const scanResults = this.state.scanResults.sort((a, b) =>
      b.id > a.id ? 1 : -1
    );
          ...
          <div className="col-md-6 col-sm-12 col-12">
            <div className="card-qr">
              <div className="card-qr-camera">
                {this.state.startScanCode ? (
                  <LegacyQRMode handleScanResult={this.handleScanResult} />
                ) : (
                  <div className="text-center">
                    <img
                      id="loc_load_disp"
                      src="/static/ScanStart.gif"
                      alt="loading"
                    />
                  </div>
                )}
            ...
            <div className="row">
              ...
              <div className="col-md-4 col-sm-4 col-4">
                ...
                {scanResultOut.status === "ok" ? (
                  ...
                  <div className="confirm-mark-not">
                    <i className="fa fa-2x fa-exclamation-circle"></i>
                  </div>
                )}
              </div>
